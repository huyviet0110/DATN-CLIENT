            ...
            <div class="container-fluid p-0">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="text-muted text-center font-size-18 fw-bold">Đăng ký</h4>
                      ...
                      <b-form ref="formRegister">
                        ...
                        <div class="form-group mt-2 mb-0 row">
                          <div class="col-12 mt-3 text-center">
                            <router-link :to="{ name: 'login' }" class="text-muted text-normal">
                              Bạn đã có tài khoản?
                            </router-link>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    register () {
      this.$userRepository.register(this.dataUser).then(() => {
        this.showToast('success', 'Hãy xác thực email để tiếp tục đăng nhập!')
