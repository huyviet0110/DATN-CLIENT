            ...
            <div class="container-fluid p-0">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="text-muted text-center font-size-18 fw-bold">Quên mật khẩu</h4>
                    ...
                    <ValidationObserver v-slot="{ handleSubmit }">
                      <b-form ref="formRegister">
                        ...
                        <b-button
                          ...
                          type="submit"
                          variant="primary"
                          @click.prevent="handleSubmit(sendMail)"
                        >
                          Tiếp tục
                        </b-button>
                      </b-form>
...
export default {
  ...
  methods: {
    sendMail () {
      this.$userRepository.sendMailForResetPassword(this.dataUser).then(() => {
